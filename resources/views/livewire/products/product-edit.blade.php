...
<div class="relative mb-6 w-full">
    ...
    <flux:subheading size="lg" class="mb-6">{{ __('Edit Your Product Here') }}</flux:subheading>
...
<a href="{{ route('product.index') }}" 
    ...
    <div class="w-170">
        <form wire:submit="submit" action="" class="mt-6 space-y-6 bg-light rounded-5">
            ...
            <flux:button type="submit" variant="primary" class="hover:bg-blue-400">Update Data</flux:button>
        </form>
    </div>
